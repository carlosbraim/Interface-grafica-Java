 ...
 * @author Carlos
 */
public class TelaPrincipalSDL extends javax.swing.JFrame {

    /**
     * Creates new form TelaPrincipalSDL
     */
    public TelaPrincipalSDL() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPrincipalSDL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPrincipalSDL().setVisible(true);
            }
        });
    }
